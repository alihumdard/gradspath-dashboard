...
const demo14ServiceMeta = {
  ...
  "Gap Year Planning": {
    ...
    icon: `
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20Zm6.9 9h-3.1a15.2 15.2 0 0 0-1.3-5A8 8 0 0 1 18.9 11ZM12 4.2c1 1.2 1.8 3.4 2 6.8h-4c.2-3.4 1-5.6 2-6.8ZM9.5 6A15.2 15.2 0 0 0 8.2 11H5.1A8 8 0 0 1 9.5 6Zm-4.4 7h3.1a15.2 15.2 0 0 0 1.3 5A8 8 0 0 1 5.1 13Zm6.9 6.8c-1-1.2-1.8-3.4-2-6.8h4c-.2 3.4-1 5.6-2 6.8ZM14.5 18a15.2 15.2 0 0 0 1.3-5h3.1a8 8 0 0 1-4.4 5Z"/>
      </svg>
    `,
  },
  "Office Hours": {
  ...
  discountPricingPreview.innerHTML = getAllServices()
    .map((service) => {
      ...
      <div class="demo14-price-card">
        <div class="demo14-price-card-title">${service}</div>
