    ...
    <div class="app">
      <section class="login-screen" id="loginScreen">
        <div class="login-card">
          <h1>Grads Paths Admin</h1>
          <p>Sign in to access the dashboard</p>

          <form id="loginForm" class="login-form">
            <input type="email" id="email" placeholder="Email" required  value="test@gmail.com"/>
      ...
      <section class="dashboard hidden" id="dashboard">
        ...
        <main class="main">
          ...
          <section class="tab-panel" id="users">
            ...
            <div class="toolbar">
              ...
              <select id="usersProgramFilter">
                ...
                <option value="CMHC">CMHC</option>
                <option value="MFT">MFT</option>
                <option value="MSW">MSW</option>
                <option value="Clinical Psy">Clinical Psy</option>
              </select>
            ...
            <div class="table-wrap panel no-pad">
              <table id="usersTable">
                ...
                <tbody>
                  <tr data-program="MBA" data-institution="Boston College">
                    <td>
                      <strong>Emma Chen</strong><span>emma@email.com</span>
                    </td>
                    <td>MBA</td>
                  ...
                  <tr data-program="Law" data-institution="Boston University">
                    <td>
                      <strong>Alex Rivera</strong><span>alex@email.com</span>
                    </td>
                    <td>Law</td>
                  ...
                  <tr data-program="CMHC" data-institution="NYU">
                    <td>
                      <strong>Mia Patel</strong><span>mia@email.com</span>
                    </td>
                    <td>CMHC</td>
                    <td>NYU</td>
                    <td>4</td>
                  ...
                  <tr data-program="MBA" data-institution="UConn">
                    <td>
                      <strong>Jordan Lee</strong><span>jordan@email.com</span>
                    </td>
                    <td>MBA</td>
                    <td>UConn</td>
                    <td>6</td>
                  ...
                  <tr data-program="MSW" data-institution="Northeastern">
                    <td>
                      <strong>Rachel Green</strong><span>rgreen@email.com</span>
                    </td>
                    <td>MSW</td>
                    <td>Northeastern</td>
                    <td>2</td>
          ...
          <section class="tab-panel" id="mentors">
            ...
            <div class="table-wrap panel no-pad">
              <table id="mentorsTable">
                ...
                <tbody>
                  <tr data-program="MBA" data-status="Active">
                    <td>
                      <strong>Sarah Kim</strong><span>sarah@email.com</span>
                    </td>
                    <td>MBA</td>
                    <td>Harvard</td>
                    <td>22</td>
                  ...
                  <tr data-program="Law" data-status="Active">
                    <td>
                      <strong>Daniel Brooks</strong><span>db@email.com</span>
                    </td>
                    <td>Law</td>
                    <td>Yale</td>
                    <td>17</td>
                  ...
                  <tr data-program="CMHC" data-status="Paused">
                    <td>
                      <strong>Leah Morris</strong><span>lm@email.com</span>
                    </td>
                    <td>CMHC</td>
                    <td>NYU</td>
                    <td>12</td>
                  ...
                  <tr data-program="MBA" data-status="Active">
                    <td>
                      <strong>Rachel Adams</strong><span>ra@email.com</span>
                    </td>
                    <td>MBA</td>
                    <td>Stanford</td>
                    <td>10</td>
                  ...
                  <tr data-program="MSW" data-status="Active">
                    <td>
                      <strong>Anthony Cruz</strong><span>acruz@email.com</span>
                    </td>
                    <td>MSW</td>
                    <td>Columbia</td>
                    <td>9</td>
          ...
          <section class="tab-panel" id="manual">
            ...
            <div class="manual-content-wrapper">
              <section class="demo14-station-panel active" id="mentor-station">
                  ...
                  <div class="demo14-page-wrap">
                    ...
                    <section class="demo14-stations-grid">
                      ...
                      >
                        ...
                        <span>Create Programs / Services</span>
                      </button>
                      <button
                        class="demo14-station-tab"
                      ...
                      <div class="demo14-white-panel">
                        <div class="demo14-station-head">
                          <div>
                            ...
                            <p>
                              Create institutions, attach offered programs,
                              connect mentors, and assign an institution
                              category.
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="demo14-form-grid">
                          ...
                          <div class="demo14-field">
                            ...
                            <input
                              ...
                              type="text"
                              placeholder="Example: University, Business School, Law School"
                            />
                          </div>

                          <div class="demo14-field full">
                            <label>Programs Offered for This Institution</label>
                            <div
                              id="institutionProgramsPicker"
                              class="demo14-checklist-grid"
                            ></div>
                          </div>

                          <div class="demo14-field full">
                            <label for="institutionMentorSearch"
                              >Search Mentors to Add to This Institution</label
                            >
                            <div
                            ...
                            >
                              <span class="demo14-search-icon">⌕</span>
                              <input
                                id="institutionMentorSearch"
                                type="text"
                                placeholder="Search mentor name, email, institution, or program..."
                              />
                            </div>
                          </div>

                          <div class="demo14-field full">
                            <label>Mentors Connected to This Institution</label>
                            <div
                              id="institutionMentorsPicker"
                              class="demo14-checklist-grid"
                            ></div>
                          </div>
                      ...
                      <div class="demo14-white-panel">
                        <div class="demo14-station-head">
                          <div>
                            ...
                            <h2>Create Programs / Services</h2>
                            <p>
                              Choose whether you want to create a new program or
                        ...
                        <div class="demo14-form-grid">
                          <div class="demo14-field full">
                            <label for="creationMode"
                              >What Are You Creating?</label
                            >
                            <select id="creationMode">
                              <option value="program">Create Program</option>
                            ...
                            <div class="demo14-form-grid">
                              ...
                              <div class="demo14-field">
                                ...
                                <input
                                  id="programCategory"
                                  type="text"
                                  placeholder="Example: Policy, Business, Healthcare"
                                />
                              </div>
                              ...
                              <div class="demo14-field full">
                                <label
                                  >Programs Showing in Filters Across Grads
                                  Paths</label
                                >
                                <div
                                  id="programFilterPreview"
                                  class="demo14-chip-grid"
                                ></div>
                              </div>
                          ...
                          >
                            <div class="demo14-form-grid">
                              ...
                              <div class="demo14-field full">
                                <label
                                  >Services Showing Across Grads Paths</label
                                >
                                <div
                                  id="serviceFilterPreview"
                                  class="demo14-chip-grid"
                                ></div>
                              </div>
