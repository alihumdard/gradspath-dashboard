...
<html lang="en">
  <head>
    ...
    <title>dashboard - Office Hours This Week</title>
    <link rel="stylesheet" href="{{ asset('assets/css/demo13.css') }}" />
     <script>
      (function () {
    ...
    <div class="app-shell">
      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <div class="nav-group">
            <a href="/student/office-hours" class="nav-item single-link active">
              <span class="nav-left">
                <span class="nav-icon" aria-hidden="true">
                  <svg
                    viewBox="0 0 24 24"
          ...
          <div class="page-shell">
              ...
              <div class="title-wrap">
                ...
                <div class="info-banner">
                  <div class="info-copy">
                    ...
                    <p>
                      If multiple students are booked, the session will focus on
                      the designated service for that week.
                    </p>
            ...
            <div class="results-bar">
              <div class="results-chip" id="resultsSummary">
                Graduates • All • All Mentors • All Schools
              </div>

              <div class="results-count">
                <span id="mentorCount">0</span> mentors shown
              </div>
            </div>
