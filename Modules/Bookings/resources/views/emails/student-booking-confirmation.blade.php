        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px; background:#ffffff; border-radius:24px; overflow:hidden; box-shadow:0 18px 50px rgba(17, 24, 39, 0.08);">
                    <tr>
                        <td style="padding:24px 32px 16px; background:linear-gradient(135deg, #111827 0%, #334155 100%); text-align:center;">
                    ...
                    <tr>
                        <td style="padding:32px 32px 24px; background:linear-gradient(135deg, #111827 0%, #334155 100%); color:#ffffff;">
                            ...
                            <p style="margin:0; font-size:16px; line-height:1.6;">Hi {{ $recipientName }}, your session with {{ $booking['mentor_name'] }} is scheduled and ready. Your Zoom meeting link is included below and will also stay available on your bookings page.</p>
                        </td>
                    </tr>
