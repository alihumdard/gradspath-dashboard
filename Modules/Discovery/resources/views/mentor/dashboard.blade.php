...
@php
  ...
  $graduateMentorsUrl = route('mentor.mentors.index', ['mentor_type' => 'graduate']);
  $professionalMentorsUrl = route('mentor.mentors.index', ['mentor_type' => 'professional']);
@endphp
        ...
        <section class="content-section institutions-section">
          ...
          <div class="school-grid">
            @forelse ($institutions as $institution)
              ...
              @endphp
              <a href="{{ route('mentor.institutions.index', ['school' => $institution->id]) }}" class="school-card">
