...
@section('admin_subtitle', 'Programs, top mentors, platform revenue, and refunds for the selected timeframe.')

@section('admin_content')
  <div class="section-head">
    <div>
      <h2>Revenue</h2>
      <p>Programs, top mentors, platform revenue, and refunds for the selected timeframe.</p>
    </div>
  ...
  <div class="summary-grid">
    ...
    <div class="small-card">
      ...
      @endif
      <small><a href="{{ route('admin.payouts') }}" style="color: inherit;">View payout ledger</a></small>
    </div>
    <div class="small-card">
