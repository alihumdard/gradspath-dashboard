    ...
    public function build(): array
    {
        ...
        return [
            ...
            'services' => $services->map(fn (ServiceConfig $service) => [
                ...
                'platform_fee_1on1' => $service->platform_fee_1on1,
                'mentor_payout_1on1' => $service->mentor_payout_1on1,
                'price_1on3_per_person' => $service->price_1on3_per_person,
                'price_1on3_total' => $service->price_1on3_total,
                'platform_fee_1on3' => $service->platform_fee_1on3,
                'mentor_payout_1on3' => $service->mentor_payout_1on3,
                'price_1on5_per_person' => $service->price_1on5_per_person,
                'price_1on5_total' => $service->price_1on5_total,
                'platform_fee_1on5' => $service->platform_fee_1on5,
                'mentor_payout_1on5' => $service->mentor_payout_1on5,
                'office_hours_subscription_price' => $service->office_hours_subscription_price,
                'office_hours_mentor_payout_per_attendee' => $service->office_hours_mentor_payout_per_attendee,
