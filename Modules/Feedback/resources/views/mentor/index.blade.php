...
<html lang="en">
  <head>
    ...
    <title>dashboard - Meeting Feedback</title>
  ...
  <body data-theme="light">
          ...
          <main class="feedback-wrapper">
            <section class="feedback-card">
              <div class="card-top">
                ...
                <p class="intro-text">
                  To maintain quality and create the best student experience, we
                  ask students to answer a few short questions after each
                  session.
                </p>
                <p class="intro-text secondary">
                  Your feedback helps improve the platform and helps future
                  students choose the right mentors.
                </p>
              </div>
              ...
              <form id="feedbackForm" novalidate>
                ...
                <div class="form-section">
                  ...
                  <div class="rating-box">
                    ...
                    <div class="rating-label" id="meetingRatingLabel">
                      Select a rating
                    </div>
                    <input
                      type="hidden"
                ...
                <div class="form-section">
                  <div class="question-title-row">
                    ...
                    <div>
                      ...
                      <p>
                        How knowledgeable and prepared did the mentor seem
                        during the session?
                      </p>
                    </div>
                  </div>
                ...
                <div class="form-section">
                  <div class="question-title-row">
                    ...
                    <div>
                      <h2>Quick Feedback <span class="required">*</span></h2>
                      <p>
                        What went well, what could have been better, and is
                        there anything else you want us to know?
                      </p>
                    </div>
                  </div>
    ...
    <script src="{{ asset('assets/js/demo6.js') }}"></script>
  </body>
</html>
