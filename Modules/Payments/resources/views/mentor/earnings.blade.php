...
@section('portal_content')
      ...
      <p class="program-note" id="programNote">Your selected program helps us track demand and improve
      ...
      <p class="footnote">Your selected program is used for internal analytics so we can
