        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:640px; background:#ffffff; border-radius:22px; overflow:hidden; box-shadow:0 18px 50px rgba(17,24,39,.08);">
          <tr>
            <td style="padding:28px 32px; background:linear-gradient(135deg,#6f4cf6,#23293a); color:#ffffff;">
              ...
              <h1 style="margin:12px 0 8px; font-size:28px; line-height:1.2;">We received your ticket</h1>
              <p style="margin:0; font-size:15px; line-height:1.6;">Hi {{ $ticket->user?->name ?? 'there' }}, our team will review {{ $ticket->ticket_ref }}.</p>
            </td>
          </tr>
          <tr>
            <td style="padding:28px 32px;">
              ...
              <a href="{{ $supportUrl }}" style="display:inline-block; padding:13px 18px; border-radius:12px; background:#6f4cf6; color:#ffffff; text-decoration:none; font-weight:700;">View my tickets</a>
            </td>
          </tr>
        </table>
      </td>
