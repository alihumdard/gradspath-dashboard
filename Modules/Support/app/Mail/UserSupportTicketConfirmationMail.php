...
class UserSupportTicketConfirmationMail extends Mailable
{
    use Queueable;
    ...
    {
        return new Envelope(
            subject: 'We received your support ticket '.$this->ticket->ticket_ref,
        );
    }
    ...
    {
        return new Content(
            view: 'support::emails.user-ticket-confirmation',
            with: [
                'ticket' => $this->ticket,
